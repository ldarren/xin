...
//import { pathOr } from './ramda.min.js'
...
export default class MimeNode {
  ...
  _processContentType () {
    ...
    this.contentType = R.pathOr(defaultValue, ['headers', 'content-type', '0'])(this)
    ...
    const contentDisposition = R.pathOr(defaultContentDispositionValue, ['headers', 'content-disposition', '0'])(this)
  ...
  _processContentTransferEncoding () {
    ...
    this.contentTransferEncoding = R.pathOr(defaultValue, ['headers', 'content-transfer-encoding', '0'])(this)
    this.contentTransferEncoding.value = R.pathOr('', ['contentTransferEncoding', 'value'])(this).toLowerCase().trim()
  }
  ...
  */
  ...
  _processFlowedText () {
    ...
    const isFlowed = /^flowed$/i.test(R.pathOr('', ['contentType', 'params', 'format'])(this))
